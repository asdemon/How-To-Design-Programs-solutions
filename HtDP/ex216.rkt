...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname ex216) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (stop? s)
  (or (<= (posn-x (ws-los s)) 0)
      (>= (posn-x (ws-los s)) WIDTH)
      (<= (posn-y (ws-los s)) 0)
      (>= (posn-y (ws-los s)) HEIGHT)))
