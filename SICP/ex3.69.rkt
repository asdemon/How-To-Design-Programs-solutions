...
(define Pythagorean
  (stream-filter (lambda (x) (= (+ (square (car x)) (square (cadr x))) (square (caddr x)))) (triples (integers-starting-from 1) (integers-starting-from 1) (integers-starting-from 1))))

(display-stream-1 Pythagorean 10)