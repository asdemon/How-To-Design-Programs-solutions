...
;a
(display-stream-1 (weighted-pairs (integers-starting-from 1) (integers-starting-from 1) (lambda (x) (+ (car x) (cadr x)))) 100)
;b
(define not-divide-2-3-5 (stream-filter (lambda (x) (not (or (= (remainder x 2) 0)
                                                             (= (remainder x 3) 0)
                                                             (= (remainder x 5) 0)))) (integers-starting-from 1)))
(display-stream-1 (weighted-pairs not-divide-2-3-5 not-divide-2-3-5 (lambda (x)
