...
(add (make-polynomial 'x '((5 3) (2 1) (1 1))) (make-polynomial 'x '((1 1))))
...
(sub (make-polynomial 'x `((5 ,(make-polynomial 'y '((1 1)))) (2 ,(make-polynomial 'y '((1 1)))) (1 ,(make-polynomial 'y '((1 1))))))
     (make-polynomial 'x `((3 ,(make-polynomial 'y '((1 1))))(1 ,(make-polynomial 'y '((1 1)))))))