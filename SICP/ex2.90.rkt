...
(add (make-polynomial-all-dense 'x '(1 1)) (make-polynomial-all-dense 'x '(1 1)))
(add (make-polynomial-all-dense 'x '(5 2 1)) (make-polynomial-all-dense 'x '(1 1)))
(negative (make-rational 1 1))
(negative (make-polynomial-all-dense 'x '(1 1)))
(negative (make-polynomial-all-dense 'x `(3 ,(make-polynomial-all-dense 'y '(1 1)) 1 ,(make-polynomial-all-dense 'y '(1 1)))))
(sub (make-polynomial-all-dense 'x '(1 1)) (make-polynomial-all-dense 'x '(1 1)))
(sub (make-polynomial-all-dense 'x '(5 3 2 1 1 1)) (make-polynomial-all-dense 'x '(1 1)))
(mul (make-polynomial-all-dense 'x '(1 1)) (make-polynomial-all-dense 'x '(1 1)))